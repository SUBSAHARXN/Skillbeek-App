      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-0 w-full z-50 bg-[#faf7fe] rounded-t-[24px] pb-[44px] pt-[8px] flex flex-col items-center shadow-[0px_-10px_30px_rgba(0,0,0,0.1)] max-h-[85%]"
          >
            {/* Handle */}
            <div className="w-[64px] h-[8px] bg-[#f0edf4] rounded-[4px] mb-[16px]" />

            <div className="w-full px-[16px] flex flex-col gap-[32px]">
              {/* Header */}
              <div className="flex flex-col gap-[16px] relative">
                <div className="flex items-center justify-center">
                  ...
                  <button
                    onClick={onClose}
                    className="absolute right-0 w-[48px] h-[48px] rounded-[32px] flex items-center justify-center bg-[#fbf6ff]"
                  >
              ...
              {/* Skills List */}
              <div className="flex flex-col gap-[24px] w-full max-h-[400px] overflow-y-auto pr-[4px] pb-[92px]">
                {skills.map((skill, index) => {
                  ...
                  return (
                    <div key={skill} className="bg-[#faf7fe] rounded-[16px] p-[16px] flex flex-col gap-[16px] shadow-[0px_4px_12px_rgba(18,9,0,0.15)]">
