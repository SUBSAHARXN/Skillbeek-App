    ...
    <div className="w-full max-w-[384px] h-[812px] bg-[var(--Surface-Primary-Background)] rounded-[32px] overflow-hidden relative flex flex-col mx-auto shadow-2xl">
        ...
        {isSessionBooking ? (
          ...
          <div className="flex flex-col relative w-full">
            <section
              ...
              className="relative flex items-center justify-between rounded-xl bg-[var(--Surface-UI-surface-surface-elevated)] px-4 py-6 border border-[var(--Surface-UI-surface-surface-elevated)] cursor-pointer hover:bg-[var(--Surface-UI-surface-surface-elevated)] transition-colors shadow-skillbeek-sm"
              aria-label="Duration selector"
            >
              <div className="relative inline-flex flex-[0_0_auto] items-center gap-1.5">
                <TimerIcon className="!relative !h-6 !w-6 !aspect-[1] text-[var(--Text-Primary-heading-1)]" />
                <span className="relative mt-[-1.00px] w-fit whitespace-nowrap font-['Nunito'] text-[16px] font-medium leading-6 tracking-[0.10px] text-[var(--Text-Primary-Subtitle)]">
                  Duration
                </span>
              </div>
              <button
              ...
              >
                <span className="relative mt-[-1.00px] flex w-fit items-end whitespace-nowrap font-['Nunito'] text-[16px] font-bold leading-6 tracking-[0.16px] text-[var(--Text-Primary-heading-3)]">
                  {formatSessionDuration()}
                </span>
                {isDropdownOpen ? (
                  <ChevronUpIcon className="!relative !h-6 !w-6 !aspect-[1] text-[var(--Text-Primary-heading-3)]" />
                ) : (
                  <ChevronDownIcon className="!relative !h-6 !w-6 !aspect-[1] text-[var(--Text-Primary-heading-3)]" />
                )}
              </button>
            </section>
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.fieldset
                  ...
                  className="mt-[4px] flex flex-col items-start gap-[12px] p-[16px] relative bg-[var(--Surface-UI-surface-surface-elevated)] rounded-xl border border-[var(--Surface-UI-surface-surface-elevated)] shadow-skillbeek-sm w-full z-10"
                >
                  ...
                  {[
                    ...
                    return (
                      <label
                        key={option.value}
                        className="flex items-center justify-between px-[16px] py-[14px] relative self-stretch w-full bg-[var(--Surface-Primary-Background)] rounded-xl border border-[var(--Surface-UI-surface-surface-elevated)] cursor-pointer hover:bg-[var(--Surface-UI-surface-surface-elevated)] transition-colors shadow-[0px_1px_1.5px_rgba(18,9,0,0.04)]"
                      >
                        <input
                          type="radio"
                        ...
                        <div className="flex items-center justify-between w-full">
                          ...
                          <div 
                            className={`w-[24px] h-[24px] rounded-full border-2 flex items-center justify-center transition-all ${
                              isSelected 
                                ? "border-[var(--Button-Primary-Stroke-Stroke-tertiary-default)] bg-transparent" 
                                : "border-[var(--Button-Primary-Stroke-Stroke-default)] bg-transparent"
                            }`}
                          >
                            {isSelected && (
                              <div className="w-[12px] h-[12px] bg-[var(--Surface-UI-surface-Surface-Universal-alternate)] rounded-full" />
                            )}
                          </div>
                        </div>
                      </label>
          ...
          <>
            ...
            {selected !== "custom" && (
              <div className="flex flex-row gap-[12px] flex-wrap">
                  ...
                  return (
                    <button
                      ...
                      className={`h-[44px] px-[16px] rounded-[99px] flex items-center justify-center transition-all font-['Nunito'] font-semibold text-[16px] leading-[24px] ${isSelected
                        ...
                        : "bg-[var(--Surface-UI-surface-surface-elevated)] text-[var(--Text-Primary-heading-3)] shadow-[0px_1px_1.5px_rgba(18,9,0,0.06)]"
                        }`}
                    >
                      {preset.label}
                    </button>
                ...
                <button
                  ...
                  className="h-[44px] px-[16px] rounded-[99px] flex items-center justify-center transition-all font-['Nunito'] font-semibold text-[16px] leading-[24px] bg-[var(--Surface-UI-surface-surface-elevated)] text-[var(--Text-Primary-heading-3)] shadow-[0px_1px_1.5px_rgba(18,9,0,0.06)]"
                >
                  Custom
                </button>
              </div>
            ...
            {selected === "custom" && (
              <div className="flex flex-col gap-[8px]">
                <span className="font-['Nunito'] font-bold text-[var(--Text-Primary-Body)] text-[14px] leading-[20px] tracking-[1px] uppercase">
                  Duration
                </span>
                <div
                  onClick={() => setIsDurationModalOpen(true)}
      ...
      <div className="absolute bottom-0 left-0 w-full bg-[var(--Surface-UI-surface-surface-elevated)] shadow-[0px_-12px_24px_rgba(18,9,0,0.02),0px_-12px_12px_rgba(18,9,0,0.04)] flex flex-col items-center gap-[32px] pt-[0px] pb-[44px] z-20">
        ...
        <div className="w-full flex items-center justify-between px-[16px]">
          <button
            onClick={onBack}
            className="font-['Nunito'] font-bold text-[var(--Text-Primary-Body)] text-[16px] leading-[24px] underline"
          >
            Back
          </button>
          <button
